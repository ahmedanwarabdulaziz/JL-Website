...
const theme = createTheme({
  palette: {
    primary: { main: "#f9c349" }, // MUI needs an actual hex for some internal calculations, but we can still use variables elsewhere
    secondary: { main: "#f9c349" },
    background: { default: "#fdfbf7", paper: "#faf9f6" },
