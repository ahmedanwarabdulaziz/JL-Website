        ...
        >
          ...
          <Box
            sx={{
              ...
              width: "50%",
              height: "100%",
              background: `radial-gradient(circle at top right, rgba(249,195,73, 0.15) 0%, transparent 70%)`,
              pointerEvents: "none",
            }}
          />
          ...
          <Box sx={{ display: "flex", justifyContent: "center", position: "relative", zIndex: 1 }}>
            <Button
              ...
              sx={{
                ...
                fontWeight: 600,
                borderRadius: 2,
                boxShadow: "0 4px 14px rgba(249,195,73, 0.4)",
                "&:hover": {
                  bgcolor: "#e56a15",
                  boxShadow: "0 6px 20px rgba(249,195,73, 0.6)",
