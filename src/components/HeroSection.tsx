...
const BEFORE_IMAGE = "/images/old.jpeg";
const AFTER_IMAGE = "/images/new.jpeg";
      ...
      >
        ...
        >
          ...
          >
           ...
           <Typography sx={{ color: "rgba(249,195,73,0.9)", fontSize: "0.75rem", letterSpacing: "0.15em", textTransform: "uppercase", fontWeight: 600 }}>After</Typography>
          </Stack>
          ...
          >
            <Button
              ...
              sx={{
                ...
                fontSize: "0.875rem",
                borderRadius: 1,
                boxShadow: "0 8px 20px rgba(249,195,73,0.3)",
                transition: "all 0.3s ease",
                "&:hover": { 
                  bgcolor: "#dfb042", 
                  boxShadow: "0 12px 28px rgba(249,195,73,0.5)",
